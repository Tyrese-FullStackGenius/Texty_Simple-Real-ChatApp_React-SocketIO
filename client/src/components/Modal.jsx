...
export default function Modal({title, message, connectionId, setTargetConnection}) {
  ...
  return (
    <div className={modalStatus ? `h-full w-full absolute flex items-center justify-center bg-white bg-opacity-30 backdrop-blur-sm transition-all` : "hidden"}>
        <div className="h-62 w-[382px] p-8 flex items-center flex-col bg-white rounded-md gap-2 transition-all">
            ...
            <h3>"<span className="text-blue-600">{connectionId}</span>"</h3>
